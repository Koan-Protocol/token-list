/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16e11c38df8ac8471f1a77b8140c879b)
// Runtime types generated with workerd@1.20251202.0 2025-12-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TokenValidationSchedulers";
	}
	interface Env {
		UPSTASH_REDIS_REST_URL: string;
		UPSTASH_REDIS_REST_TOKEN: string;
		ONEINCH_API_KEY: string;
		TokenValidationSchedulers: DurableObjectNamespace<import("./src/index").TokenValidationSchedulers>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "ONEINCH_API_KEY">> {}
}
